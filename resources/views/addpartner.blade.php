                ...
                <div class="card card-info" style=" border-radius:20px;">
                  <div class="card-body">
                    <div class="input-group mb-3">
                      <input style="border-radius:15px;" type="text" class="form-control" placeholder="Nama Partner">
                    </div>
                    <div class="input-group mb-3">
                      <input style="border-radius:15px; height=100px;" type="text" class="form-control" placeholder="Alamat">
                    </div>
                    <div class="input-group mb-3">
