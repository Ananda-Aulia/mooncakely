        ...
        <div class="row" style="justify-content: center; border-radius:20px; background-color:red;padding:2px;box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23); background-color:#ededed;">
          ...
          <div class="col-lg-6 col-12" style="padding:10px;">
            <div class="row">
              ...
              <div class="col-6">
                <div class="input-group mb-3">
                  <input style="border-radius:15px;" type="text" class="form-control" placeholder="Nama Barang">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-6">
                <input style="border-radius:15px;" type="text" class="form-control" placeholder="Kategori">
              </div>
              <div class="col-6">
            ...
            <div class="input-group mb-3">
              <input style="border-radius:15px;" type="text" class="form-control" placeholder="Deskripsi">
            </div>
            <div class="addout">
              QTY&nbsp;&nbsp;&nbsp;
